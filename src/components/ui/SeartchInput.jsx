  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className="w-full rounded-[12px] bg-gray-100 h-[54px] tablet:h-[42px] py-[9px] pl-[56px] tablet:pl-[48px] pr-[20px] text-[16px] text-gray-900 placeholder:text-gray-400"
      />
    </div>
  );
}
